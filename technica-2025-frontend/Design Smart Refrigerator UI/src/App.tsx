...
import { Thermometer, Package, ShoppingCart, Zap, Droplets, Heart, Flower2, Leaf } from 'lucide-react';
    ...
    >
      ...
      <div className="w-full max-w-[920px] mx-auto relative z-10">
        ...
        <div className="relative">
          ...
          {/* Main Fridge Body */}
          <div className="bg-white p-4 shadow-2xl" style={{
            ...
            <div className="flex gap-4">
              ...
              <div 
                ...
                style={{
                  background: 'linear-gradient(135deg, #9DC8A3 0%, #88B68E 50%, #7AA580 100%)',
                  borderRadius: '24px',
                  border: '5px solid white',
                  boxShadow: 'inset 0 2px 20px rgba(255,255,255,0.3), 0 8px 24px rgba(0,0,0,0.12)'
                }}
              >
                ...
                <div className="flex justify-center pt-8 pb-6">
                  ...
                  >
                    <div className="text-center">
                      ...
                      <div className="text-[10px] text-[var(--eco-dark)] tracking-wider mt-0.5">♡ SMART & SWEET ♡</div>
                    </div>
                  </div>
                </div>
                  ...
                  >
                    <div className="text-center mb-3">
                      <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#88B68E] to-[#7AA580] px-4 py-1.5 rounded-full mb-2">
                        ...
                        <span className="text-xs font-bold text-white">DISPENSER</span>
                      </div>
                    </div>
                ...
                <div className="flex-1 flex items-end justify-center pb-8">
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-bold text-[var(--eco-dark)]">ECO MODE ♡</span>
                      <span className="text-xl">✨</span>
                    </div>
                  </div>
                </div>
              ...
              >
                ...
                <div 
                  ...
                  style={{
                    ...
                    boxShadow: '0 8px 32px rgba(0,0,0,0.2), inset 0 0 0 2px white'
                  }}
                >
                  <div className="h-full bg-gradient-to-br from-[var(--eco-cream)] to-white rounded-xl overflow-hidden flex flex-col">
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between relative z-10">
                        <div className="flex items-center gap-2">
                          <span className="text-xl">🌿</span>
                          <div>
                            <h2 className="font-bold text-sm">EcoFridge Control</h2>
                            <p className="text-[9px] opacity-90">✿ Smart Dashboard ✿</p>
                          </div>
                        </div>
                        <div 
                          className="text-right text-xs bg-white/20 backdrop-blur px-3 py-1.5 rounded-full border border-white/30"
                        >
                    ...
                    <div 
                      ...
                      style={{ background: 'linear-gradient(to bottom, #FFF8DC, #FFFEF7)' }}
                    >
                      {tabs.map((tab) => {
                        const Icon = tab.icon;
                        ...
                        return (
                          <button
                            ...
                            style={{
                              ...
                              borderRadius: '16px',
                              border: isActive ? '3px solid var(--eco-pink)' : '3px solid transparent',
                              boxShadow: isActive ? '0 4px 12px rgba(0,0,0,0.1)' : 'none'
                            }}
                          >
                            <Icon 
                              className={`w-5 h-5 ${isActive ? 'text-[var(--eco-green)]' : 'text-[var(--eco-dark)]/60'} transition-transform`} 
                            />
                            <span 
                              className={`text-[10px] font-medium ${isActive ? 'text-[var(--eco-green)]' : 'text-[var(--eco-dark)]/60'}`}
                            >
                              {tab.label}
                            </span>
                          </button>
                    ...
                    <div className="flex-1 overflow-y-auto bg-gradient-to-br from-white to-[var(--eco-mint)]/30" style={{ minHeight: 0 }}>
                      <div className="p-4">
            ...
            <div 
              ...
              style={{
                background: 'linear-gradient(135deg, #88B68E 0%, #7AA580 50%, #6B9471 100%)',
                borderRadius: '24px',
                border: '5px solid white',
                boxShadow: 'inset 0 2px 20px rgba(255,255,255,0.3), 0 8px 24px rgba(0,0,0,0.12)'
              }}
            >
              ...
              <div className="flex gap-8 mb-6">
                <div 
                  className="text-center bg-white/20 backdrop-blur px-4 py-2 rounded-2xl border-2 border-white/40"
                >
              ...
              <div className="absolute top-6 right-12 text-xl opacity-30 text-white">❄️</div>
              <div className="absolute bottom-6 left-12 text-lg opacity-30 text-white">❄️</div>
            </div>
          </div>

          {/* Bottom scalloped edge */}
          <div className="w-full h-2 bg-white relative">
            <div className="absolute top-0 left-0 right-0 h-full bg-[#88B68E]" style={{
              clipPath: 'polygon(0 0, 5% 100%, 10% 0, 15% 100%, 20% 0, 25% 100%, 30% 0, 35% 100%, 40% 0, 45% 100%, 50% 0, 55% 100%, 60% 0, 65% 100%, 70% 0, 75% 100%, 80% 0, 85% 100%, 90% 0, 95% 100%, 100% 0)'
            }}></div>
          </div>
          ...
          >
            {Array.from({ length: 50 }).map((_, i) => (
              <div key={i} className="w-1 h-5 bg-[var(--eco-dark)]/30 rounded-full"></div>
            ))}
          </div>
        </div>
